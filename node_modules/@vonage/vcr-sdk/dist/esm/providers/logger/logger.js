...
import { LogAction } from "./contracts/logAction.js";
import { SOURCE_TYPE } from "./enums/sourceType.js";
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.createLogAction = function (level, message, context) {
    ...
    Logger.prototype.log = function (level, message, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var logAction, requestParams;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logAction = this.createLogAction(level, message, context);
