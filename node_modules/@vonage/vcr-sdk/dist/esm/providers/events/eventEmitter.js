...
import { SessionCreatedDetails } from "./contracts/sessionCreatedDetails.js";
import { VCR_EVENT_TYPE } from "./enums/vcrEventType.js";
var EventEmitter = /** @class */ (function () {
    function EventEmitter(session) {
        this.provider = "events-submission";
        this.config = session.config;
        this.bridge = session.bridge;
        this.session = session;
        this.eventFactory = new EventFactory(this.session);
        this.url = this.config.getExecutionUrl(this.provider);
    }
    EventEmitter.prototype.emitSessionCreatedEvent = function (ttl) {
        return __awaiter(this, void 0, void 0, function () {
            var expiresAt, details, event;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        expiresAt = this.bridge.toISOString(ttl);
                        details = new SessionCreatedDetails(expiresAt);
                        event = this.eventFactory.createEvent(VCR_EVENT_TYPE.SESSION_CREATED, details);
                        return [4 /*yield*/, this.emit(event)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
