...
import { ExpireOptions } from "./expireOptions.js";
/**
...
export declare class State implements IState {
    ...
    provider: string;
    /**
     * The command service for the state object.
     */
     ...
     * @returns {Promise<string>} A promise that resolves to "1" if the key was deleted, or "0" if the key did not exist.
     */
    hdel(htable: string, keys: string[]): Promise<string>;
    /**
     ...
     */
    hgetall(htable: string): Promise<Record<string, string>>;
    /**
     ...
     */
    hmget(htable: string, keys: string[]): Promise<string[]>;
    /**
     ...
     */
    hvals(htable: string): Promise<string[]>;
    /**
     ...
     */
    hget(htable: string, key: string): Promise<string>;
    /**
     ...
     */
    hset(htable: string, keyValuePairs: Record<string, string>): Promise<string>;
    /**
     ...
     */
    hincrby(htable: string, key: string, value: number): Promise<string>;
    /**
     ...
     */
    hlen(htable: string): Promise<string>;
    hscan(htable: string, cursor: string, pattern: string, count: number): Promise<[string, string[]]>;
    /**
     ...
     */
    rpush<T>(list: string, value: T): Promise<string>;
    /**
     ...
     */
    rpop<T>(list: string, count?: number): Promise<T[]>;
    /**
     ...
     * @returns {Promise<string>} A promise that resolves to the new length of the list.
     */
    lpush<T>(list: string, value: T): Promise<string>;
    /**
     ...
     */
    lpop<T>(list: string, count?: number): Promise<T[]>;
    /**
     ...
     */
    lrem<T>(list: string, value: T, count?: number): Promise<string>;
    /**
     ...
     */
    llen(list: string): Promise<string>;
    /**
     ...
     */
    lrange<T>(list: string, startPos?: number, endPos?: number): Promise<T[]>;
    /**
     ...
     * @returns {Promise<string>} A promise that resolves to "OK" if the operation was successful.
     */
    ltrim<T>(list: string, startPos: number, endPos: number): Promise<string>;
    /**
     ...
     */
    linsert<T>(list: string, before: boolean, pivot: T, value: T): Promise<string>;
    /**
     ...
     */
    lindex<T>(list: string, position: number): Promise<T>;
    /**
     ...
     * @returns {Promise<string>} A promise that resolves to "OK" if the operation was successful.
     */
    lset<T>(list: string, position: number, value: T): Promise<string>;
    /**
     ...
     */
    incrby<T>(key: string, value: number): Promise<string>;
    /**
     ...
     * @returns {Promise<string>} A promise that resolves to the new value of the key.
     */
    decrby<T>(key: string, value: number): Promise<string>;
    /**
     ...
     */
    expire(key: string, seconds: number, option?: ExpireOptions): Promise<string>;
