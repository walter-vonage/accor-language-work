...
const sessionCreatedDetails_js_1 = require("./sessionCreatedDetails.js");
...
class EventEmitter {
    ...
    emitSessionCreatedEvent(ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const event = this.eventFactory.createEvent(neruEventTypes_js_1.NeruEventTypes.SESSION_CREATED, details);
